...
from .batch_viz import save_baseline_figures, save_classnumber_baseline_figures, save_classnumber_figures, save_count_partial_figures, save_wdm_raw_figures, save_classnumber_wdm_raw_figures, save_summary_figures, save_classnumber_summary_figures
...
def _save_requested_figures(
    ...
    if args.mode == "count-partial":
        ...
        _safe_viz(save_summary_figures, args, ref_gm, rows, log_dir, label="summary")
        ...
        _safe_viz(save_classnumber_summary_figures, args, ref_gm, rows, log_dir, label="classnumber summary")
