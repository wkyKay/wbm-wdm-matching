...
def _match_row(fname: str, match: dict, per_token: bool) -> list[str]:
    ...
    common = [
        ...
        _fmt_float(match.get("moment_sim_raw", "")),
        _fmt_float(match.get("geometry_sim_raw", "")),
        _fmt_float(match.get("scale_area_ratio", "")),
        _fmt_float(match.get("scale_long_ratio", "")),
        _fmt_float(match.get("scale_short_ratio", "")),
